...
function InfoModal({ showModal, closeModal }) {
  ...
  const nickCheck = () => {
    ...
    if (nickname.length >= 3) {
      ...
      window.alert("3글자 이상의 닉네임을 적어주세요.");
    }
  };
  const profileUpdate = () => {
    //TODO : 수정완료
        ...
        <div className="header_modal_container info_modal">
          ...
          <div>
            <div className="personal_info_edit">
              ...
              <div className="division_edit">
                ...
                >
                  ...
                  <option name="worker" value="8">
                    {" "}
                    직장인{" "}
                  </option>
                  <option name="worker" value="9">
                    {" "}
                    취준생{" "}
                  </option>
                </Select>
            ...
            <div className="userservice">
              ...
              <p className="userservice_btn">
                <a href="https://forms.gle/WemcWEYWGBVoSjxW8" target="_blank">
                  사용자피드백
                </a>
              </p>
            </div>
            <div className="logout clearfix">
              <p className="logout_btn fr" onClick={logout}>
                로그아웃
              </p>
            </div>
          </div>
